...
type categoryArray = {
  ...
  export const [state, setState] = React.useState({
    number: 10,
    category: 9,
...
const useStyles = makeStyles((theme) => ({
  ...
  const UserData: React.FC = () => {
    ...
    if(loading){
        ...
        <Button variant="contained" color="primary" style={{display: 'block', margin: 'auto', width: '81%', marginTop: '10px', background: '#94b9eb'}}>
        Submit
      </Button>
      </div>
        )
